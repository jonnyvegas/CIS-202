...
void totalGrade(Student& theStudent)
{
    ...
    theStudent.quiz1 = theStudent.quiz1 * .125;                   //Each quiz is worth 12.5%
    theStudent.quiz2 = theStudent.quiz2 * .125;                   //because they total 25%.
    theStudent.midterm = theStudent.midterm * .25;                //Midterm worth 25%.
    theStudent.finalTest = theStudent.finalTest * .50;            //Final worth 50%.
    theStudent.finalTotal = (theStudent.quiz1 + theStudent.quiz2  //Added together will be out of 100
                  + theStudent.midterm + theStudent.finalTest);   //to get the final grade.
